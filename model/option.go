...
func InitOptionMap() {
	...
	common.OptionMap[CustomMenuPagesOptionKey] = "[]"
	...
	common.OptionMap["InviteRechargeRebateRatio"] = strconv.FormatFloat(common.InviteRechargeRebateRatio, 'f', -1, 64)
	...
	common.OptionMap[ratio_setting.GroupRatioScheduleOptionKey] = ratio_setting.GroupRatioSchedule2JSONString()
...
func UpdateOptionsBulk(values map[string]string) error {
	...
	if err := publishOptionUpdates(values); err != nil {
		return err
	}
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "InviteRechargeRebateRatio":
		common.InviteRechargeRebateRatio, _ = strconv.ParseFloat(value, 64)
	...
	case ratio_setting.GroupRatioScheduleOptionKey:
		err = ratio_setting.UpdateGroupRatioScheduleByJSONString(value)
