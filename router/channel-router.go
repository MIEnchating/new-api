...
var channelPermissionRoutes = []permissionRoute{
	...
	{method: http.MethodGet, path: "/route/affinity", permission: authz.ChannelRead, handler: controller.GetChannelRouteAffinityStats},
	{method: http.MethodGet, path: "/route/channels", permission: authz.ChannelRead, handler: controller.GetChannelExecutionOptions},
	{method: http.MethodGet, path: "/route/plan", permission: authz.ChannelRead, handler: controller.GetChannelExecutionPlan},
	{method: http.MethodGet, path: "/route/traces", permission: authz.ChannelRead, handler: controller.GetRecentChannelExecutionTraces},
	{method: http.MethodGet, path: "/route/trace/:request_id", permission: authz.ChannelRead, handler: controller.GetChannelExecutionTrace},
	...
	{method: http.MethodPost, path: "/:id/route/cooldown/clear", permission: authz.ChannelOperate, handler: controller.ClearChannelRouteCooldown},
	{method: http.MethodDelete, path: "/route/affinity", permission: authz.ChannelOperate, handler: controller.ClearAllChannelRouteAffinity},
	{method: http.MethodDelete, path: "/:id/route/affinity", permission: authz.ChannelOperate, handler: controller.ClearChannelRouteAffinity},
