...
func TestStreamStatus_SetEndReason_Concurrent(t *testing.T) {
	...
	reasons := []StreamEndReason{
		...
		StreamEndReasonUpstreamClosedEarly,
		StreamEndReasonMissingTerminal,
		StreamEndReasonUpstreamTerminalErr,
...
func TestStreamStatus_IsNormalEnd(t *testing.T) {
	...
	tests := []struct {
		...
		{StreamEndReasonUpstreamClosedEarly, false},
		{StreamEndReasonMissingTerminal, false},
		{StreamEndReasonUpstreamTerminalErr, false},
