...
const AUDIT_TEMPLATES: Record<string, string> = {
  ...
  'redemption.invoice_issue':
    'Marked redemption credit {{reference}} as invoiced',
  'redemption.invoice_return':
    'Returned invoice marker for redemption credit {{reference}}',
