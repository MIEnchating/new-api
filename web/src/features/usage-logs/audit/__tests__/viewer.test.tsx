...
it.each([
  [
    'en',
    en,
    'Updated channel 42 status to Disabled',
    'Updated 1 of 2 channels to Enabled',
  ],
  [
    'zh',
    zh,
    '已将渠道 42 的状态更新为已禁用',
    '已将 2 个渠道中的 1 个状态更新为已启用',
  ],
  [
    'zh-TW',
    zhTW,
    '已將渠道 42 的狀態更新為已停用',
    '已將 2 個渠道中的 1 個狀態更新為已啟用',
  ],
  [
    'fr',
    fr,
    'Statut du canal 42 mis à jour : Désactivé',
    'Mise à jour de 1 canal(aux) sur 2 vers Activé',
  ],
  [
    'ja',
    ja,
  ...
  [
    'ru',
    ru,
    'Статус канала 42 изменён на «Отключено»',
    'Статус 1 из 2 каналов изменён на «Включено»',
  ],
  [
    'vi',
    viLocale,
    'Đã cập nhật trạng thái kênh 42 thành Đã tắt',
    'Đã cập nhật 1/2 kênh thành Đã bật',
  ],
] as const)(
