...
describe('system branding', () => {
  ...
  test('shows a logo-free loading indicator before React mounts', () => {
    ...
    assert.match(indexHtml, /id="app-bootstrap-progress"/)
    assert.match(indexHtml, /app-bootstrap-progress/)
    assert.match(indexHtml, /app-bootstrap-track-outer/)
    assert.match(indexHtml, /app-bootstrap-track-inner/)
    assert.match(indexHtml, /app-bootstrap-orbit-outer/)
    assert.match(indexHtml, /app-bootstrap-orbit-inner/)
    assert.match(indexHtml, /app-bootstrap-core/)
    assert.doesNotMatch(indexHtml, /loading-logo/)
