...
// External tests create a new database per case on the explicitly configured
// disposable instance, including instances addressed by container hostnames.
// They never drop databases or tables supplied through an environment variable.
